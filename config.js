// PRODUCTOS - Lista completa del Sheet (amarillos activos)
const PRODUCTOS_CONFIG = [
    ...
    { nombre: 'CALABAZA [POR PESO]', precio: 1500, unidad: 'kilo', peso: '1000 gr', emoji: '🎃' },
    ...
    { nombre: 'HUEVOS DE CAMPO [POR 1/2 DOC.]', precio: 2500, unidad: 'unidad', peso: '1/2 DOC', emoji: '🥚' },
    { nombre: 'HUEVOS DE CAMPO [POR 1 DOC.]', precio: 5000, unidad: 'unidad', peso: '1 DOC', emoji: '🥚' },
